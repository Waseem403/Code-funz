...
const useStyles = makeStyles(muiBaseTheme => ({
  ...
  avatar1: {
    ...
    height: 100,
    align: 'center',
    paddingLeft:muiBaseTheme.spacing(3),
    fontSize:'65px',
    marginTop: "-7%",
    borderRadius: '8%',
    "&:not(:first-of-type)": {
      ...
      <Hidden mdUp>
        <div className={classes.paper}>
          ...
          <Container component="main" align="center" maxWidth="md">
            ...
            <Typography variant="caption" display="block" gutterBottom>
              <i className="fas fa-birthday-cake"></i>{"  "}  <Moment format="DD-MM-YYYY">{profile.DOB}</Moment>
            </Typography>
            <Typography variant="caption" display="block" gutterBottom>
            ...
            <Typography variant="caption" display="block" gutterBottom>
              <i className="far fa-calendar-alt"></i> joined on{" "}
            ...
            <div className={classes.socialbtnmob}>
              ...
              {isEmpty(profile.social && profile.social.facebook) ? null : (
                <Link
                  ...
                  target="_blank"
                >
                  <i className="fab fa-facebook-f fa-1x" />{" "}
                </Link>
              )}
