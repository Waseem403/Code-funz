...
import { OtherUserReactlove, OtherUserReactUnlove, OtherUserReactlike, OtherUserReactDislike } from "../../../../../actions/profilevisitoraction"
...
import RepliesMenu from "./RepliesMenu"
...
function PostLists(props) {
  ...
  const onLoveClick = Love_Info => {
    props.OtherUserReactlove(Love_Info);
  }

  //function which dislove the post
  const onUnloveClick = Love_Info => {
    props.OtherUserReactUnlove(Love_Info);
  }


  //function which love the post
  const onLikeClick = Love_Info => {
    props.OtherUserReactlike(Love_Info);
  }

  //function which dislove the post
  const onDislikeClick = Love_Info => {
    props.OtherUserReactDislike(Love_Info);
  }
    ...
    FeedsContent = (
      <React.Fragment>
        <Card className={classes.card}>
          ...
          <RepliesMenu anchorEl={anchorEl} feeds={feeds} handleClose={handleClose} feedId={feeds._id} CurrentPostProfileId={feeds.user} />
...
export default connect(
  mapStateToProps,
  { OtherUserReactlove, OtherUserReactUnlove, OtherUserReactlike, OtherUserReactDislike }
)(PostLists);
